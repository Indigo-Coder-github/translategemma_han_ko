...
|-----------|------|------|
| trailing space | 37 | |
| 한자 불일치 | 9,956 | 번역의 `(漢字)`가 원문에 미포함 |
| 중복 용어 | 22,543 | 동일 인물/용어 반복 언급 (대부분 정상) |
| 인라인 각주 | 3,855 | `content` 폴백 기사에서 주로 발생 |
| 총 플래그 기사 | 30,389 (8.1%) | |
...
| 항목 | 수치 |
|------|------|
| 그대로 통과 (≤2048 tokens) | 363,331건 (71.9%) |
| 청킹 대상 (>2048 tokens) | 12,739건 |
| 생성된 청크 수 | 142,275개 (평균 11.2청크/기사) |
| **총 출력** | **505,606건** |
...
|-------|------|------|------------|-------|-----------|-------|
| train | 374,736 | 80.0% | 408 | 198,249 (52.9%) | 106,603 (28.4%) | 69,884 (18.6%) |
| val | 46,842 | 10.0% | 406 | 24,964 (53.3%) | 13,233 (28.3%) | 8,645 (18.5%) |
| test | 46,842 | 10.0% | 406 | 24,858 (53.1%) | 13,281 (28.4%) | 8,703 (18.6%) |
